...
TOOL_SPEC_REGISTRY: "OrderedDict[str, ToolSpec]" = OrderedDict(
    ...
    for spec in [
        ...
        ToolSpec(
            ...
            metadata=_meta(entity="board", scope="daily", data_freshness="end_of_day", update_timing="T+1_16:00", supports_history=False, source="both", source_priority="tushare", api_name="dc_index", primary_key="board_code"),
        ),
        ToolSpec(
        ...
        ToolSpec(
            ...
            metadata=_meta(entity="stock", scope="daily", data_freshness="end_of_day", update_timing="T+1_16:00", supports_history=False, source="both", source_priority="tushare", api_name="dc_index,dc_member", primary_key="symbol"),
        ),
        ToolSpec(
            ...
            metadata=_meta(entity="board", scope="historical", data_freshness="end_of_day", update_timing="T+1_16:00", supports_history=True, history_start="20200101", source="both", source_priority="tushare", api_name="dc_index,dc_daily", primary_key="trade_date"),
        ),
        ToolSpec(
