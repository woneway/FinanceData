...
TOOL_REGISTRY: Dict[str, ToolMeta] = {
    ...
    "tool_get_lhb_active_traders": ToolMeta(
        ...
        source=DataSource.AKSHARE,
        source_priority="akshare",
        api_name="stock_lhb_yytj_sina",
        primary_key="branch_name",
    ...
    "tool_get_lhb_stock_detail": ToolMeta(
        ...
        source=DataSource.AKSHARE,
        source_priority="akshare",
        api_name="stock_lhb_detail_daily_sina",
        primary_key="symbol",
    ...
    "tool_get_suspend": ToolMeta(
        ...
        source=DataSource.AKSHARE,
        source_priority="akshare",
        api_name="stock_tfp_em",
        return_fields=["symbol", "name", "suspend_date", "resume_date", "reason"],
    ),

    # === Sector (list/member/history) ===
    "tool_get_sector_list": ToolMeta(
    ...
    "tool_get_sector_member": ToolMeta(
    ...
    "tool_get_sector_history": ToolMeta(
        ...
        source=DataSource.AKSHARE,
        source_priority="akshare",
        api_name="stock_board_industry_hist_em",
        return_fields=["date", "open", "close", "high", "low", "volume", "amount", "pct_chg"],
    ),

    # === Hot Rank ===
    "tool_get_hot_rank": ToolMeta(
        ...
        source=DataSource.AKSHARE,
        source_priority="akshare",
        api_name="stock_hot_rank_em",
        return_fields=["rank", "symbol", "name", "current", "pct_chg"],
    ),

    # === LHB Inst Detail ===
    "tool_get_lhb_inst_detail": ToolMeta(
