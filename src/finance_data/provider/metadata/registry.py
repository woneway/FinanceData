...
TOOL_REGISTRY: Dict[str, ToolMeta] = {
    ...
    "tool_get_financial_summary": ToolMeta(
        ...
        return_fields=["date", "revenue", "net_profit", "roe", "gross_margin"],
    ),
    ...
    "tool_get_dividend": ToolMeta(
        ...
        source_priority="akshare",
        api_name="stock分红",
        return_fields=["date", "dividend", "bonus_share", "rights_issue"],
    ),
    ...
    "tool_get_earnings_forecast": ToolMeta(
        ...
        source=DataSource.BOTH,
        source_priority="akshare",
        api_name="stock_profit_forecast",
        return_fields=["date", "forecast_type", "net_profit_min", "net_profit_max"],
    ),
    ...
    "tool_get_zt_pool": ToolMeta(
        ...
        limitations=["非实时，收盘后约15:30更新；无历史查询"],
