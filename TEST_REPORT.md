...
| 8 | `tool_get_index_kline_history` | tushare | ❌ FAIL | 0 | 0.11 | [auth] 您的token不对，请确认。 |
| 9 | `tool_get_board_index_history` | tushare | ❌ FAIL | 0 | 0.04 | [auth] 您的token不对，请确认。 |
...
| 12 | `tool_get_financial_summary` | tushare | ❌ FAIL | 0 | 0.04 | [auth] 您的token不对，请确认。 |
...
| 17 | `tool_get_lhb_detail_history` | tushare | ❌ FAIL | 0 | 0.03 | [auth] 您的token不对，请确认。 |
| 18 | `tool_get_north_hold_daily` | tushare | ❌ FAIL | 0 | 0.03 | [auth] 您的token不对，请确认。 |
...
| 22 | `tool_get_margin_detail_history` | tushare | ❌ FAIL | 0 | 0.03 | [auth] 您的token不对，请确认。 |
