...
| 17 | `tool_get_lhb_detail_history` | tushare | ❌ FAIL | 0 | 0.04 | [auth] 您的token不对，请确认。 |
| 18 | `tool_get_north_hold_daily` | tushare | ❌ FAIL | 0 | 0.04 | [auth] 您的token不对，请确认。 |
